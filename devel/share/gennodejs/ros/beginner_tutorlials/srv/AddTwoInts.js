...
// (in-package beginner_tutorlials.srv)
...
class AddTwoIntsRequest {
  ...
  static datatype() {
    ...
    return 'beginner_tutorlials/AddTwoIntsRequest';
  }
...
class AddTwoIntsResponse {
  ...
  static datatype() {
    // Returns string type for a service object
    return 'beginner_tutorlials/AddTwoIntsResponse';
  }
...
module.exports = {
  ...
  datatype() { return 'beginner_tutorlials/AddTwoInts'; }
};
